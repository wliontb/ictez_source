<div class="row">
	<div class="col-md-8">
		<nav class="breadcrumb">
		    <a class="breadcrumb-item" href="<?php echo base_url() ?>"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
		    <span class="breadcrumb-item">Thể loại</span>
		...
		<div class="custom-panel rounded-bottom">
			...
			<?php echo (empty($dataposts)) ? '<p class="text-center font-weight-bold p-1">Chưa có bài viết !</p>' : '' ?>
			<?php foreach($dataposts as $bv) : ?>
            <div class="post row no-gutters">
                <div class="col-sm-3 p-1">
                    <img class="w-100 rounded" height="160px" src="<?php echo $bv['Thumbnail'] ?>" alt="<?php echo $bv['Title']?>">
                </div>
