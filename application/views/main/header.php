<?php
$cf = $this->SettingModel->getValues();
?>
<!DOCTYPE html>
<html>
<head>
    <title><?php echo (isset($title) ? $title : $cf[6]['Value']); ?></title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="Nguyễn Viết Tuấn Anh">
    <meta name="keywords" content="<?php echo empty($cf[5]['Value']) ? 'ictez,ictu,nguyentuananh,wlion98,codeigniter,php,reactjs,nodejs' : $cf[5]['Value'] ?>">
    ...
    <meta property="og:title" content="<?php echo (isset($title) ? $title : $cf[6]['Value']); ?>"/>
    <meta property="og:description" content="<?php echo empty($datapost['Des']) ? '' : $datapost['Des']; ?>"/>
    <meta property="og:image" content="<?php echo empty($datapost['Thumbnail']) ? $cf[7]['Value'] : $datapost['Thumbnail']; ?>"/>
